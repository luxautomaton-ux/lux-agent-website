...
export const metadata: Metadata = {
  ...
  description:
    "Inland Circle Program OS is a custom program operations system built with Lux Automaton. It helps community and nonprofit programs organize participants, outreach, events, resources, volunteer coordination, and reporting.",
};

const solution = SOLUTIONS.find((s) => s.slug === "inland-circle-program-o")!;

const ACCENT = "#00e5ff";
const ACCENT_DIM = "rgba(0, 229, 255, 0.12)";
const ACCENT_BORDER = "rgba(0, 229, 255, 0.22)";
const ACCENT_GLOW = "rgba(0, 229, 255, 0.08)";
  ...
  return (
    <div style={{ paddingTop: "72px", background: "var(--bg-void)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: "48px", alignItems: "center" }} className="hero-grid">
            <div>
              ...
              >
                ...
                <span
                  style={{
                    background: `linear-gradient(135deg, ${ACCENT}, #00b4cc)`,
            ...
            >
              ...
              <div style={{ marginTop: "20px", fontSize: "0.72rem", color: "var(--text-muted)", lineHeight: 1.6 }}>
                Secure local instance<br />Community Operations
              </div>
            </div>
          </div>
        </div>
      ...
      <section
        style={{
          padding: "80px 24px",
          background: "linear-gradient(135deg, rgba(0,229,255,0.05) 0%, rgba(6,11,20,1) 60%)",
          borderTop: "1px solid var(--border-subtle)",
          borderBottom: "1px solid var(--border-subtle)",
        }}
      >
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                Ready to Organize Your<br />Program Operations?
              </h2>
              <p style={{ color: "var(--text-muted)", fontSize: "1rem", lineHeight: 1.7, maxWidth: "520px", margin: "0 auto 40px" }}>
                Work with Lux Automaton to deploy a custom Program OS instance for your team. Your workflows, your staff, your way.
              </p>
