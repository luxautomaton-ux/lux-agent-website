...
export const metadata: Metadata = {
  title: "Epic Electric — Contractor Operations System | Lux Automaton",
  description:
    "Epic Electric is a custom contractor operations system built with Lux Automaton. It helps an electrical business manage leads, quotes, customer communication, scheduling, reviews, and checklists.",
};

const solution = SOLUTIONS.find((s) => s.slug === "epic-electric")!;

const ACCENT = "#ff6b00";
const ACCENT_DIM = "rgba(255, 107, 0, 0.12)";
const ACCENT_BORDER = "rgba(255, 107, 0, 0.22)";
const ACCENT_GLOW = "rgba(255, 107, 0, 0.08)";
...
export default function EpicElectricPage() {
  return (
    <div style={{ paddingTop: "72px", background: "var(--bg-void)" }}>
      ...
      <section
        style={{
          ...
          alignItems: "center",
          overflow: "hidden",
          backgroundImage: `linear-gradient(to bottom, rgba(3, 5, 18, 0.78) 0%, rgba(3, 5, 18, 0.93) 100%), url(${prefixPath("/images/epic-electric-hero.png")})`,
      ...
      >
        ...
        <div
          style={{
            ...
            width: "800px",
            height: "500px",
            background: "radial-gradient(ellipse, rgba(255,107,0,0.09) 0%, transparent 65%)",
            pointerEvents: "none",
          }}
        />
        {/* Bottom border glow */}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: "48px", alignItems: "center" }} className="hero-grid">
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
                ...
                />
                <span style={{ fontSize: "0.8rem", color: ACCENT, fontWeight: 600 }}>Active OS</span>
              </div>
              <div style={{ marginTop: "20px", fontSize: "0.72rem", color: "var(--text-muted)", lineHeight: 1.6 }}>
                Field-ready local sync<br />Contractor Operations
              </div>
            </div>
          </div>
        </div>
      ...
      <section
        style={{
          padding: "80px 24px",
          background: "linear-gradient(135deg, rgba(255,107,0,0.05) 0%, rgba(6,11,20,1) 60%)",
          borderTop: "1px solid var(--border-subtle)",
          borderBottom: "1px solid var(--border-subtle)",
        }}
      >
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                Ready to Organize Your<br />Contractor Operations?
              </h2>
              <p style={{ color: "var(--text-muted)", fontSize: "1rem", lineHeight: 1.7, maxWidth: "520px", margin: "0 auto 40px" }}>
                Work with Lux Automaton to deploy a custom Epic Electric system for your team. Your service, your staff, your way.
              </p>
